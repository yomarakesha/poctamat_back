...
class ErrorCode(StrEnum):
    ...
    CUSTODY_ALREADY_CLOSED = "CUSTODY_ALREADY_CLOSED"
    CUSTODY_NOT_DUE = "CUSTODY_NOT_DUE"
    ...
    CELL_HAS_ACTIVE_BOOKING = "CELL_HAS_ACTIVE_BOOKING"
    CELL_POSITION_OCCUPIED = "CELL_POSITION_OCCUPIED"
    HARDWARE_ADDRESS_DUPLICATE = "HARDWARE_ADDRESS_DUPLICATE"
    LAYOUT_EXCEEDS_GRID = "LAYOUT_EXCEEDS_GRID"
    BULK_CREATE_PARTIAL_FAILURE = "BULK_CREATE_PARTIAL_FAILURE"
    REMOTE_OPEN_NOT_ALLOWED = "REMOTE_OPEN_NOT_ALLOWED"
    DEVICE_OFFLINE = "DEVICE_OFFLINE"
    LOCK_AGENT_UNAVAILABLE = "LOCK_AGENT_UNAVAILABLE"
